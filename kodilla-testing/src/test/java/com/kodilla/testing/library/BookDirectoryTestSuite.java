...
class BookDirectoryTestSuite {
    ...
    class TestListBooksInHandsOf {
        ...
        void testListBooksInHandsOfNoBooks() {
            // Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser theUser = new LibraryUser("John", "Smith", "840101123456");

            // When
            List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(theUser);
        ...
        void testListBooksInHandsOfOneBook() {
            ...
            LibraryUser theUser = new LibraryUser("John", "Smith", "840101123456");
            when(libraryDatabaseMock.listBooksInHandsOf(theUser))
